...
class SCNN(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.view_select =  nn.Linear(cs[2], kwargs['out_channels'])
    ...
    def forward(self, z, pres, vres):
        # x: SparseTensor z: PointTensor
        x0 = initial_voxelize(z, pres, vres)
        ...
        view_weights = torch.sigmoid(self.view_select(z2.F))
